...
const compilePython = function (envData, code, fn) {
...
const compilePythonWithInput = function (envData, code, input, fn) {
    var filename = cuid.slug();
    const path = './temp/';
...
export const pythonCompileService = { compilePython, compilePythonWithInput };
